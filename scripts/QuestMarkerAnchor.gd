...
#func _process(_delta):
	...
	#print($Node2D.to_global($Node2D/ColorRect.rect_position))
	#print(get_parent().make_canvas_position_local($Node2D/ColorRect.get_global_rect().position))
#	print($Node2D.to_local())
